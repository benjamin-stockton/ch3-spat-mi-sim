...
saveRDS(x1, file = paste0(out_path, "/test-sim-results-mar-spat-mi-", Sys.Date(), "-sim_setting-", 2, ".rds"))

x2 <- x1 |>
    dplyr::bind_rows()
f_out <- paste0(out_path, "/test-sim-results-mar-spat-mi-sim_setting-", 2, ".csv")
